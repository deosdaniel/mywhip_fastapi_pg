            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <p
                    className={`absolute -top-1 text-red-500 text-sm transition-all duration-200 ${errors.email ? "opacity-100" : "opacity-0"}`}
                  >
                    {errors.email}
                  </p>
                </div>
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  <p
                    className={`absolute -top-1 text-red-500 text-sm transition-all duration-200 
              ...
              <div className="text-center text-sm">
                Нет аккаунта?
                <Link to="/signup" className="font-bold hover:underline px-1">
                  Зарегистрироваться
                </Link>
              </div>
            </div>
