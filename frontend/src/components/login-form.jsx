                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-muted-foreground text-balance">
                                    Войдите в свой аккаунт "My Whip"
                                </p>
                            </div>
                            <div className="grid gap-2">
                                ...
                                <div className="relative">
                                    <p className={`absolute -top-1 text-red-500 text-sm transition-all duration-200 ${errors.email ? 'opacity-100' : 'opacity-0'}`}>
                                        {errors.email}
                                    </p>
                                </div>
                            </div>
                            <div className="grid gap-2">
                                ...
                                />
                                <div className="relative">
                                    <p className={`absolute -top-1 text-red-500 text-sm transition-all duration-200 
                ...
                <span className="bg-card text-muted-foreground relative z-10 px-2">
                  Or continue with
                            ...
                            <div className="text-center text-sm">
                                Нет аккаунта?
                                <Link to='/signup2' className='font-bold hover:underline px-1'>
                                    Зарегистрироваться
                                </Link>
                            </div>
                        </div>
