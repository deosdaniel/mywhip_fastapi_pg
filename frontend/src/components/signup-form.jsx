                        ...
                        <div className="flex flex-col gap-6">
                                ...
                                <div className='flex space-x-4 mb-2'>
                                    <div className='w-1/2 gap-y-3'>
                                        ...
                                        <div className="relative">
                                            <p className={`absolute text-red-500 text-sm transition-all duration-200 
                            ...
                            ${errors.last_name ? 'opacity-100' : 'opacity-0'}`}>
                                ...
                                <div className='grid gap-3'>
                                    ...
                                    />
                                    <div className="relative">
                                        <p className={`absolute -top-3 text-red-500 text-sm transition-all duration-200 
                            ${errors.username ? 'opacity-100' : 'opacity-0'}`}>
                                ...
                                <div className="grid gap-3">
                                    ...
                                    />
                                    <div className="relative">
                                        <p className={`absolute -top-3 text-red-500 text-sm transition-all duration-200 ${errors.email ? 'opacity-100' : 'opacity-0'}`}>
                                            {errors.email}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="text-center text-sm">
                                Уже есть аккаунт?
                                <Link to='/login2' className='font-bold hover:underline px-1'>
                                    Войти
                                </Link>
                            </div>
                        </div>
