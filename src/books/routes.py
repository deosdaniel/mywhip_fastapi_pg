...
from src.books.service import BookService   # our CRUD-methods
...
async def update_book(
    ...
    if not updated_book:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail='Cannot update not existing book')
    else:
        return updated_book
